...
Mi apreciación de la palabra "madre" se define de la siguiente manera: Madre es toda aquella mujer que toma la responsabilidad de cuidar a su hijo que aún no es capaz de cuidarse por sí mismo. Y cuidar a su vez incluye la tarea de preparar de forma personal a dicha persona para ser autosuficiente por sí misma, es decir que, el resultado de una madre es evidencial en la capacidad que tiene el hijo para enfrentar el mundo por su propia cuenta. Quizá no sea notorio, pero, me es importante enfatizar que toda madre debe tener una participación activa y no pasiva, por ejemplo, proveer la alimentación y el costo de los estudios de sus hijos es una acción pasiva, por tanto, eso no cubre la expectativa de ser madre. De cualquier forma, mi objetivo al proponer esta definición es poder hacer un contraste de perspectivas, eso significa que es perfectamente válido tener perspectivas diferentes sobre el tema, esto nos permite explorar las implicaciones de los sistemas de creencias.
...
Ahora, este tema evita algunos detalles que deben ser mencionados a fin cubrir en la medida posible con una respuesta que pueda satisfacer cualquier perspectiva de la misma palabra.
  ...
  1. La asociación expectativa-sujeto - Asociar un sujeto a una palabra, es equivalente a usar pronombres, o titulos, o adjetivos, todo aquello que sirve para reconocer a un sujeto sin hacer uso de su identidad. Si consideramos un gerente dentro de la empresa, vemos por experiencia que asociamos el título a la persona antes que su identidad, y entonces usualmente vemos empleados llamar a la persona en cuestión por el titulo en lugar de su nombre.
  ...
  1. La expectativa - Para que una palabra finalmente tenga sentido, debe existir una definición concreta sobre la expectativa del uso de la palabra, que a su vez, debe ser entendida por aquellos que usan la palabra. Si existe la palabra "bombero", debe existir una expectativa sobre la actividad, tarea, o implicación de un bombero, que debe ser entendida por quien se dice que es un bombero (A), y por quien usa la palabra bombero (B) para referirse a la persona que ejerce tal actividad (A).

Estos tres conceptos se relacionan a partir de la expectativa, es decir, la expectativa genera la asociación y esta última a su vez da lugar a la relación personal. He aquí un ejemplo, si alguien desarrollara un nuevo concepto de profesión, en el ejercicio de la profesión existe una expectativa de lo que debe hacerse, y ya que en principio tal profesión no tiene un nombre particular, no podemos decir que existe una asociación entre la persona y la expectiva, puesto que no hay un nombre con qué asociar tal expectativa. Sin embargo,eventualmente la asociación surge en virtud de la expectativa, es decir, la asociación recibe un nombre derivado de la actividad; es entonces cuando existe la relación personal, o en otras palabras, una segunda persona empieza a usar esta asociación sobre una persona.
...
Aunque pueda sonar afirmativo, tenemos un problema, si no existe una relación personal entonces, ¿Quién la llamaría madre?

Ahora, sólo para reforzar la importancia del sentido práctico de las palabras con definición concreta. Si cambiamos la palabra "madre" por "amigo", es lógicamente igual, puedes llamar amigo a quien quieras pero, la persona debe actuar como amigo para que la palabra tenga sentido, y a su vez la palabra amigo debe estar claramente definida para que ambos sépan la expectativa que tiene uno del otro. Y creo que podríamos aplicar el mismo principio para cualquier titulo: policia, presidente, médico, etc; sin importar su implicación legal.

### El problema de ambiguedad

El tema principal de esta sección son las deficiones vagas y/o ambiguas. Y algo que pensé por un tiempo para resolver este dilema de significados, era usar la etimología. Así, al día de hoy todos tendríamos una definición concreta basado en el origen de cada palabra en particular, sin embargo; si usáramos la etimología de esta manera, terminaríamos cayendo en una trampa llamada "falacia etimológica". El problema con esta falacia es que las palabras actuales han redefinido su significado de acuerdo al cambio social, cultural, y muchas otras variables, un ejemplo de esto podría ser la palabra "bug"; que en su significado original en inglés se entiende como insecto o bicho pero, su significado es mayormente reconocido como "error de software", incluso podríamos decir que hasta cierto punto se pierde el significado original de la palabra debido a este significado popular, es por esa razón que es una falacia, porque es falso pensar que todas las palabras de hoy deben significar lo mismo que cuando se inventaron. Ahora, si consideramos que existen lenguajes que no tienen una traducción equivalente palabra por palabra, el problema con la etimología se vuelve peor.
...
Por cierto, espero que no olvides las respuestas que formulámos en esta sección, las mismas deberían tener una respuesta al final del capítulo.
...
Entonces, de acuerdo a las proposiciones anteriores, las posibilidad de cualquier sistema serían las siguientes:
  ...
  * Sistemas reales
    * Válido - Como la globalización, mecánica básica, programación, etc.
    * Inválido - Alguien jugando un juego de mesa de forma equivocada, o alguien teniendo respuestas equivocadas en matemáticas.
  * Sistemas irreales
    * Válido - Como los juegos de mesa de fantasía, novelas, peliculas de ficción, etc.
    * Inválido - El lenguaje prohibido de las hadas serpientes, un mapa élfico hacia el centro de la tierra, alguien hablando incoherencias.
...
Una de las cosas que me sorprende, es una estra consciencia implicita sobre los sitemas que nos rodean. Algunos sistemas son fáciles de identificar y aún así estamos completamente inconsciente de ellos, la mayoría del tiempo incluso actuamos con el sistema sin notarlo. Hagámos un ejercicio mental, paremos por un momento y pensemos en todos los sitemas que han sido mencionados hasta ahora en este capítulo.

¿Listo?

Efectivamente son bastantes ¿Verdad?. Además si pensamos un poco más sobre cada uno de estos estos sitemas, encontraremos que todos de alguna forma repiten un ciclo, que nosotros interactuamos con estos ciclos sin entenderlo completamente, ejemplos como la lluvia, frío y calor, comer y dormir, el amanecer y el anochecer, los números, y así. Esto nos da a entender que todos los sitemas en algún nivel son determinísticos, es decir, existe una expectativa de anticipación.
