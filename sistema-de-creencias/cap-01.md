...
Supongamos que tienes una conversación con un extraño, y hablan sobre economía, proyectos personales, ideologías y más, pero durante la conversación, observas que él usa ciertas palabras de forma extraña, tal vez palabras como existencia, moralidad, amor, felicidad, etc. Y luego de más conversación, tienes la impresión de que tal vez no comparten el mismo significado de ciertas palabras ¿Alguna has conversado con alguien que parece usar sus palabras con una precisión extraña?

Aún si no has tenido ese tipo de experiencias, es bueno saber que este es un caso de incertidumbre, y en tales casos, es importante hacerse ciertas preguntas.
...
Este es el tipo de problemas que existe gracias a la ambiguedad, y es el inicio de un mar de posibilidades no deseadas. Permíteme compartir un par de ejemplos más para demostrar hasta que punto este tipo de problemas son comunes.
...
Veamos si podemos aplicar las reglas que hemos definido al inicio del ejemplo para ayudarnos a resolver este problema.
...
De hecho, si escribes este ejercicio tal como lo ves en una calculadora, tendrías la respuesta correcta. Ahora, solo para aclarar, estoy usando el símbolo "+" para expresar explícitamente los dos conceptos que contiene; el signo positivo y la operación de adición pero, como habrás notado ya, usar el mismo símbolo para expresar ambos conceptos hace que el ejercicio sea innecesariamente más difícil de entender.

Para agregar un poco de distinción en este punto, podríamos agrupar términos y el resultado sería mucho mas evidente, pero, tendríamos que escribir mucho más, y al final no estamos resolviendo el problema de raíz. Observa el mismo ejemplo usando paréntesis.
...
Mi apreciación de la palabra "madre" se define de la siguiente manera: Madre es toda aquella mujer que ha tomado la responsabilidad de cuidar a una persona que todavia no es capaz de cuidarse por cuenta propia. Y cuidar a su vez incluye la tarea de preparar de forma personal a dicha persona, a quien le corresponde el nombre de hijo, para ser autosuficiente, es decir que, el resultado de una madre es evidente en la capacidad que tiene su hijo para enfrentar el mundo por cuenta propia. Quizá no sea notorio, pero, me es importante enfatizar que toda madre debe tener una participación activa y no pasiva en su rol, por ejemplo, proveer la alimentación y el costo de los estudios de sus hijos es una acción pasiva, por tanto, eso no cubre la expectativa de ser madre, por el contrario, sentarse con su hijo y enseñarle aquello que como madre y mujer sabe, cubre la participación activa. De cualquier forma, mi objetivo al proponer esta definición es poder hacer un contraste de perspectivas, puesto que esta diferencia nos permite explorar las implicaciones de los sistemas de creencias, eso significa que es perfectamente válido tener perspectivas diferentes sobre el tema. Te animo a comparar y evaluar tu propia perspectiva de madre en este ejemplo.
...
Aunque pueda sonar afirmativo, tenemos un problema, si no existe una relación personal entonces, ¿Quién la llamaría madre? Tal vez, aquí yo podría argumentar que cualquier persona puede llamarla madre, pero luego mi pregunta sería, ¿Con qué perspectiva e intensión la llaman madre?
...
Solo para aclarar las cosas, no sugiero que debieramos quitar tales definiciones compuestas de nuestro vocabulario, pues el significado en sí mismo es bastante explícito, pero, mi enfoque es reconocer que de ambas definiciones usualmente sólo una es concreta. Pensamos en esto: si el significado de "madre" es la expresión usada para denotar la relación personal entre dos individuos, entonces, decir "madre biólogica" tiene la intensión de expresar la relación biológica de ambas personas, pero, la responsabilidad y expectativa de dicha relación personal aún es vaga en definición, es decir, si escuchamos "madre biológica" entendemos que es son parientes de sangre pero, no sabemos si ella ejerce correctamente su rol de madre. Para evitar este tipo de incertidumbres, yo podría reemplazar la expresión "madre biológica" por progenitora, y más allá de ser válido, es mucho más concreto en lo que quiero decir intencionalmente.
...
Si recapitulamos el ejemplo "madre o no" podríamos notar que originalmente el ejemplo no encaja mucho con la definición de "ambiguedad léxica", es decir, si no hubieramos definido un concepto concreto sobre la expectativa de madre, entonces fuera evidente que los posibles significados de la palabra "madre" no tienen una definición concreta. En tal caso, la ambiguedad de la palabra "madre" podría ser descrita así: para cualquier mensaje, existe una palabra tal que tiene multiples significados, y todos estos significados comparten muchas similitudes pero, ellos difieren en ciertos casos, por ende, el significado intencional del mensaje podría ser parcialmente entendido. Contrario a "ambiguedad léxica", este problema nos lleva a creer que hemos entendido el mensaje correctamente pero, la realidad es que muy probablemente entendimos solo una parte de ello.
