...
La observación que debemos hacer finalmente es, ¿Quién afirma que Dios es omnipotente y bueno? Y este "quién" debe explicarnos entonces que significa "Dios", "bueno", "malo" y "omnipotente", y solo entonces, podemos responder la solución a este problema.
...
Entonces, retomando el problema del mal, el primer error que surge al querer resolverlo, es que intentamos mezclar el concepto humano de bien y mal con el que corresponde usar desde la perspectiva de Dios mismo. Es decir, la perspectiva de Dios que define el bien y mal debe ser, por cuestiones de capacidad, parcialmente iguales a las del hombre, pero, por extensión de entendimiento, la definición de bien y mal de Dios debe ser extremadamente diferente a la del hombre.
